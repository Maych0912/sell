<template>
  <div class='shop'>
    ...
    <transition name='fadetra'>
      <div class='list-mask' v-show='listShow' @click='listhidden'></div>
    </transition>
  </div>
</template>
...
<style lang='stylus' type="stylesheet/stylus">
  ...
  .list-mask
    ...
    &.fadetra-enter-active, &.fadetra-leave-active {
        transition: 0.5s
      }
    &.fadetra-enter, &.fadetra-leave-active {
      opacity: 0
    }
